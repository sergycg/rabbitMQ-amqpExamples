...
public class WorkQueuesConfig {
    ...
    public Queue hello() {
    	...
    	arguments.put("x-single-active-consumer", true);
     	return new Queue("hello", false, false, false, arguments);
    }
...
//	
	...
	@Bean
	public WorkQueuesReceiver receiver4() {
	    return new WorkQueuesReceiver(4);
	}
//	@Bean
//	public WorkQueuesReceiver receiver5() {
//	    return new WorkQueuesReceiver(5);
//	}
//
//	@Bean
//	public WorkQueuesReceiver receiver6() {
//	    return new WorkQueuesReceiver(6);
//	}
    }
